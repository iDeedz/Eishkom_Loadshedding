...
Public Class SePush
  ...
  Public Shared Function GetStatusText(ByVal status As Integer) As String
    Select Case status
      ...
      Case 1
        GetStatusText = "Stage 1"
      Case 2
        GetStatusText = "Stage 2"
      Case 3
        GetStatusText = "Stage 3"
      Case 4
        GetStatusText = "Stage 4"
      Case 5
        GetStatusText = "Stage 5"
      Case 6
        GetStatusText = "Stage 6"
      Case 7
        GetStatusText = "Stage 7"
      Case 8
        GetStatusText = "Stage 8"
      Case Else
        GetStatusText = "Unknown"
    End Select
